...
//====================================================
class RelevantCard {
  final rock = RPS(onChanged: (value) {}).rps(
      GameColor().rockColor,
      GameColor().rockShadowColor,
      const AssetImage('assets/img/icon-rock.png'),
      indicate == 'rock' ? boxShadow : null);
  final paper = RPS(onChanged: (value) {}).rps(
      GameColor().paperColor,
      GameColor().paperShadowColor,
      const AssetImage('assets/img/icon-paper.png'),
      indicate == 'paper' ? boxShadow : null);
  final scissors = RPS(onChanged: (value) {}).rps(
      GameColor().scissorColor,
      GameColor().scissorShadowColor,
      const AssetImage('assets/img/icon-scissors.png'),
      indicate == 'scissors' ? boxShadow : null);
  final lizard = RPS(onChanged: (value) {}).rps(
      GameColor().lizardColor,
      GameColor().lizardShadowColor,
      const AssetImage('assets/img/icon-lizard.png'),
      indicate == 'lizard' ? boxShadow : null);
  final spock = RPS(onChanged: (value) {}).rps(
      GameColor().spockColor,
      GameColor().spockShadowColor,
      const AssetImage('assets/img/icon-spock.png'),
      indicate == 'spock' ? boxShadow : null);
}
...
user(String value, String level) {
  ...
  whatUserPicked = value == 'rock'
      ? RelevantCard().rock
      : value == 'paper'
          ? RelevantCard().paper
          : value == 'scissors'
              ? RelevantCard().scissors
              : value == 'lizard'
                  ? RelevantCard().lizard
                  : value == 'spock'
                      ? RelevantCard().spock
...
var whoWon = '';
whoWin() {
  if (userPick == 'rock' && comPick == 'paper' ||
  ...
  } else if (userPick == 'rock' && comPick == 'scissors' ||
